(function($){
	...
	$.each(all_converter,function(e){
		...
		if (numHyphen < numHyphen_next) {
		    ...
		    //
		    item = item + '<li>' +"\n";
		    item = item + '<i class="fa fa-plus-square"></i>' + "\n";
		    item = item + '<label>' + "\n";
	...
	if (typeof(methodName) == "undefined" ) {
		...
		//change symbols
		if (options.collapsedSymbol != "fa-plus-square") {
		    $(this).find("i").removeClass("fa-plus-square").addClass(options.collapsedSymbol);
		}
	...
	SymbolPrefix: "fa",
	expandedSymbol: "fa-minus-square",
	collapsedSymbol: "fa-plus-square",
	collapseAll: true,
	checkboxes: "enabled",
